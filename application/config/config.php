...
$config['sess_cookie_name'] = 'jeevanpraman';
...
$config['cookie_path']		= '/';
$config['cookie_secure']	= FALSE;//FALSE
...
$config['csrf_token_name'] = 'sspnadmin';
$config['csrf_cookie_name'] = 'sspnadminn';
...
$config['proxy_ips'] = '';
/******For Group**********/
$config['array_group_item']=array('EPFO','TNCPT','MHMBPT','PARPT','NMGPT');
$config['string_group_item']="'EPFO','TNCPT','MHMBPT','PARPT','NMGPT'";
