...
<div class="col-sm-6 wrap-contact100" style="margin-left:-10px;">			
		...
		echo form_open('admin/login',$attributes);?>
				...
				<div class="col-sm-9">
					<input name="username" id="username" autocomplete="off" maxlength="20" onpaste="return false;" type="textbox" class="form-control formtext" placeholder="Username"> 
					<span style="color:red;"><?php echo form_error('username'); ?></span>
				</div>

				<label class="col-sm-3 formtext" for="Mobile">Password:</label>
				<div class="col-sm-9">
					<input autocomplete="off" maxlength="50" onpaste="return false;" type="password" class="form-control formtext" placeholder="Password" name="password" id="password">
					<span style="color:red;"><?php echo form_error('password'); ?></span>
				</div> 
				
				<label class="col-sm-3 formtext">Enter Captcha:</label>
				<div class="col-sm-5">
					<input class="form-control formtext" type="text" name="captcha_code" id="captcha_code" placeholder="Enter Capcha" onkeypress="return isNumberKey(event)" autocomplete="off" maxlength="6">
				...
				<div class="col-sm-9">					
					<a class="small" href="<?php echo base_url()?>admin/register">For Register</a>
				</div>
